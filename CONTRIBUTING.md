...
* create or respond to an issue for on the [Github Repository](http://github.com/ruby-rdf/rdf-aggregate-repo/issues)
* Fork and clone the repo:
  `git clone git@github.com:your-username/rdf-aggregate-repo.git`
* Install bundle:
  `bundle install`
